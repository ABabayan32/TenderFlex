...
public class Config {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, AuthenticationManager authenticationManager) throws Exception {
       ...
       return http.csrf().disable()
               ...
               .authorizeHttpRequests().requestMatchers(HttpMethod.GET,  "/offers/{id}/decisionFileKey").hasAnyAuthority(ROLE_BIDDER).and()
               .authorizeHttpRequests().requestMatchers(HttpMethod.GET,  "/offers/me/**").hasAnyAuthority(ROLE_BIDDER).and()
               .authorizeHttpRequests().requestMatchers(HttpMethod.GET,  "/offers/me/{id}").hasAnyAuthority(ROLE_BIDDER).and()
               ...
               .authorizeHttpRequests().requestMatchers(HttpMethod.GET,  "/tenders/me/**").hasAnyAuthority(ROLE_CONTRACTOR).and()
               .authorizeHttpRequests().requestMatchers(HttpMethod.GET,  "/tenders/{id}").hasAnyAuthority(ROLE_BIDDER).and()
               .authorizeHttpRequests().requestMatchers(HttpMethod.GET,  "/tenders/{id}/offers").hasAnyAuthority(ROLE_CONTRACTOR).and()
               .authorizeHttpRequests().requestMatchers(HttpMethod.GET,  "/tenders/{id}/offers/me").hasAnyAuthority(ROLE_BIDDER).and()
